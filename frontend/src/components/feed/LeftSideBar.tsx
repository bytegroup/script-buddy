...
const suggestedPeople = [
    { name: "Steve Jobs",      role: "CEO of Apple",    initials: "SJ", color: "#1890FF" },
    { name: "Ryan Roslansky",  role: "CEO of LinkedIn", initials: "RR", color: "#0ACF83" },
    { name: "Dylan Field",     role: "CEO of Figma",    initials: "DF", color: "#F7941D" },
];

// ── Events ────────────────────────────────────────────────────────────────────
const events = [
    { day: "10", month: "Jul", title: "Global Developer Summit 2025", going: 142 },
    { day: "24", month: "Aug", title: "Open Source Contributors Meetup", going: 87 },
];
        ...
        <div className="_layout_left_sidebar_wrap">
                        ...
                        <div key={person.name} className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <div
                                        className="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold _info_img"
                                        style={{ background: person.color, width: 40, height: 40, fontSize: 14, flexShrink: 0 }}
                                    >
                                        {person.initials}
                                    </div>
                                </div>
            ...
            <div className="_layout_left_sidebar_inner">
                <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                    ...
                    {events.map((ev) => (
                        <div key={ev.title} className="_left_inner_event_card_link">
                            <div className="_left_inner_event_card">

                                {/* Image */}
                                <div
                                    className="_left_inner_event_card_iamge"
                                    style={{
                                        height: 80,
                                        background: "linear-gradient(135deg, #1890FF22, #1890FF55)",
                                        borderRadius: 6,
                                        display: "flex",
                                        alignItems: "center",
                                ...
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="none" viewBox="0 0 24 24">
                                        <path fill="#1890FF" d="M19 4h-1V2h-2v2H8V2H6v2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2zm0 16H5V9h14v11z"/>
                                    </svg>
                                </div>
                                ...
                                <div className="_left_inner_event_bottom">
                                    <p className="_left_iner_event_bottom">
                                        {ev.going} People Going
                                    </p>

                                    {/* just text, since no action */}
